...
// GetAuditLogs1Opts Optional parameters for the method 'GetAuditLogs1'
type GetAuditLogs1Opts struct {
...
/*
GetAuditLogs1 Audit log
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetAuditLogs1Opts - Optional Parameters:
 * @param "Offset" (optional.Int32) -
 * @param "Query" (optional.String) -
 * @param "PageSize" (optional.Int32) -
@return AuditLogUiResponse
*/
func (a *AuditLogApiService) GetAuditLogs1(ctx _context.Context, localVarOptionals *GetAuditLogs1Opts) (AuditLogUiResponse, *_nethttp.Response, error) {
	var (
