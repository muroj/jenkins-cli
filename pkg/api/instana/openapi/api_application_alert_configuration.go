...
func (a *ApplicationAlertConfigurationApiService) CreateApplicationAlertConfig(ctx _context.Context, applicationAlertConfig ApplicationAlertConfig) (ApplicationAlertConfigWithMetadata, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/application-alert-configs"
	...
	// body params
	localVarPostBody = &applicationAlertConfig
	if ctx != nil {
...
func (a *ApplicationAlertConfigurationApiService) DeleteApplicationAlertConfig(ctx _context.Context, id string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/application-alert-configs/{id}"
...
// DisableApplicationAlertConfigOpts Optional parameters for the method 'DisableApplicationAlertConfig'
type DisableApplicationAlertConfigOpts struct {
...
*/
func (a *ApplicationAlertConfigurationApiService) DisableApplicationAlertConfig(ctx _context.Context, id string, localVarOptionals *DisableApplicationAlertConfigOpts) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/application-alert-configs/{id}/disable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
...
// EnableApplicationAlertConfigOpts Optional parameters for the method 'EnableApplicationAlertConfig'
type EnableApplicationAlertConfigOpts struct {
	Body optional.String
}
 ...
 * @param "Body" (optional.String) -
*/
func (a *ApplicationAlertConfigurationApiService) EnableApplicationAlertConfig(ctx _context.Context, id string, localVarOptionals *EnableApplicationAlertConfigOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/application-alert-configs/{id}/enable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
...
// FindActiveApplicationAlertConfigsOpts Optional parameters for the method 'FindActiveApplicationAlertConfigs'
type FindActiveApplicationAlertConfigsOpts struct {
...
// FindApplicationAlertConfigOpts Optional parameters for the method 'FindApplicationAlertConfig'
type FindApplicationAlertConfigOpts struct {
...
func (a *ApplicationAlertConfigurationApiService) FindApplicationAlertConfigVersions(ctx _context.Context, id string) ([]ConfigVersion, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/application-alert-configs/{id}/versions"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
