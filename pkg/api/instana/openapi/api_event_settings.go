 ...
 * @param "Body" (optional.String) -
*/
func (a *EventSettingsApiService) DisableWebsiteAlertConfig(ctx _context.Context, id string, localVarOptionals *DisableWebsiteAlertConfigOpts) (*_nethttp.Response, error) {
	var (
 ...
 * @param "Body" (optional.String) -
*/
func (a *EventSettingsApiService) EnableWebsiteAlertConfig(ctx _context.Context, id string, localVarOptionals *EnableWebsiteAlertConfigOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
