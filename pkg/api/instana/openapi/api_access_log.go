...
*/
func (a *AccessLogApiService) GetAuditLogs(ctx _context.Context, localVarOptionals *GetAuditLogsOpts) (AccessLogResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/settings/accesslog"
