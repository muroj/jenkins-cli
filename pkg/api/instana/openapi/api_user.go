...
*/
func (a *UserApiService) GetInvitations(ctx _context.Context) ([]InvitationResult, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/settings/invitations"
...
// InviteUsersOpts Optional parameters for the method 'InviteUsers'
type InviteUsersOpts struct {
	Invitation optional.Interface
}

/*
InviteUsers Send user invitations
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *InviteUsersOpts - Optional Parameters:
 * @param "Invitation" (optional.Interface of []Invitation) -
*/
func (a *UserApiService) InviteUsers(ctx _context.Context, localVarOptionals *InviteUsersOpts) (*_nethttp.Response, error) {
	var (
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.Invitation.IsSet() {
		localVarOptionalInvitation, localVarOptionalInvitationok := localVarOptionals.Invitation.Value().([]Invitation)
		if !localVarOptionalInvitationok {
			return nil, reportError("invitation should be []Invitation")
		}
		localVarPostBody = &localVarOptionalInvitation
	}
 ...
 * @param email
*/
func (a *UserApiService) RevokePendingInvitation(ctx _context.Context, email string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *UserApiService) UpdateUser(ctx _context.Context, email string, localVarOptionals *UpdateUserOpts) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/settings/users/{email}"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.EditUser.IsSet() {
		localVarOptionalEditUser, localVarOptionalEditUserok := localVarOptionals.EditUser.Value().(EditUser)
		if !localVarOptionalEditUserok {
			return nil, reportError("editUser should be EditUser")
		}
		localVarPostBody = &localVarOptionalEditUser
	}
