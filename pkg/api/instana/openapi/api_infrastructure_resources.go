...
@return SnapshotItem
*/
func (a *InfrastructureResourcesApiService) GetSnapshot(ctx _context.Context, id string, localVarOptionals *GetSnapshotOpts) (SnapshotItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *InfrastructureResourcesApiService) GetSnapshots(ctx _context.Context, localVarOptionals *GetSnapshotsOpts) (SnapshotResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
