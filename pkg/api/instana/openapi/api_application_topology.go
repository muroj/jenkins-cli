...
// GetServicesMapOpts Optional parameters for the method 'GetServicesMap'
type GetServicesMapOpts struct {
 ...
 * @param optional nil or *GetServicesMapOpts - Optional Parameters:
 * @param "WindowSize" (optional.Int64) -
 * @param "To" (optional.Int64) -
@return ServiceMap
*/
func (a *ApplicationTopologyApiService) GetServicesMap(ctx _context.Context, localVarOptionals *GetServicesMapOpts) (ServiceMap, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/application-monitoring/topology/services"
