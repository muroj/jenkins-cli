...
func (a *GlobalApplicationAlertConfigurationApiService) CreateGlobalApplicationAlertConfig(ctx _context.Context, globalApplicationsAlertConfig GlobalApplicationsAlertConfig) (GlobalApplicationAlertConfigWithMetadata, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/global-alert-configs/applications"
	...
	// body params
	localVarPostBody = &globalApplicationsAlertConfig
	if ctx != nil {
...
func (a *GlobalApplicationAlertConfigurationApiService) DeleteGlobalApplicationAlertConfig(ctx _context.Context, id string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/global-alert-configs/applications/{id}"
...
// DisableGlobalApplicationAlertConfigOpts Optional parameters for the method 'DisableGlobalApplicationAlertConfig'
type DisableGlobalApplicationAlertConfigOpts struct {
...
func (a *GlobalApplicationAlertConfigurationApiService) DisableGlobalApplicationAlertConfig(ctx _context.Context, id string, localVarOptionals *DisableGlobalApplicationAlertConfigOpts) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/global-alert-configs/applications/{id}/disable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
...
// EnableGlobalApplicationAlertConfigOpts Optional parameters for the method 'EnableGlobalApplicationAlertConfig'
type EnableGlobalApplicationAlertConfigOpts struct {
	Body optional.String
}
...
func (a *GlobalApplicationAlertConfigurationApiService) EnableGlobalApplicationAlertConfig(ctx _context.Context, id string, localVarOptionals *EnableGlobalApplicationAlertConfigOpts) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/global-alert-configs/applications/{id}/enable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
...
// FindActiveGlobalApplicationAlertConfigsOpts Optional parameters for the method 'FindActiveGlobalApplicationAlertConfigs'
type FindActiveGlobalApplicationAlertConfigsOpts struct {
...
// FindGlobalApplicationAlertConfigOpts Optional parameters for the method 'FindGlobalApplicationAlertConfig'
type FindGlobalApplicationAlertConfigOpts struct {
...
func (a *GlobalApplicationAlertConfigurationApiService) FindGlobalApplicationAlertConfigVersions(ctx _context.Context, id string) ([]ConfigVersion, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/events/settings/global-alert-configs/applications/{id}/versions"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
