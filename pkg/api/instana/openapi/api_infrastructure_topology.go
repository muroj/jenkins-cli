...
@return []string
*/
func (a *InfrastructureTopologyApiService) GetRelatedHosts(ctx _context.Context, snapshotId string) ([]string, *_nethttp.Response, error) {
	var (
...
// GetTopologyOpts Optional parameters for the method 'GetTopology'
type GetTopologyOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetTopologyOpts - Optional Parameters:
 * @param "IncludeData" (optional.Bool) -
@return Topology
*/
func (a *InfrastructureTopologyApiService) GetTopology(ctx _context.Context, localVarOptionals *GetTopologyOpts) (Topology, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/infrastructure-monitoring/topology"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
